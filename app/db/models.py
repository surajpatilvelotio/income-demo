...
from sqlalchemy import Boolean, Date, DateTime, ForeignKey, Identity, Integer, String, Text, JSON
...
class User(Base):
    ...
    auto_id: Mapped[int] = mapped_column(Integer, Identity(always=True), unique=True, nullable=False)
