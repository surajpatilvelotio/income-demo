...
async def seed_mock_government_records(session: AsyncSession) -> None:
    ...
    positive_records = [
        ...
        MockGovernmentRecord(
            document_number="PASS-US-123456",
            document_type="passport",
            first_name="Robert",
            last_name="Johnson",
            date_of_birth=date(1982, 11, 8),
            address={"street": "321 Elm St", "city": "Houston", "state": "TX", "zip": "77001"},
            is_valid=True,
            is_flagged=False,
        ),
        MockGovernmentRecord(
            document_number="ID-2024-009999",
            document_type="id_card",
            first_name="Maria",
            last_name="Garcia",
            date_of_birth=date(1995, 7, 25),
            address={"street": "555 Cedar Ln", "city": "Miami", "state": "FL", "zip": "33101"},
            is_valid=True,
            is_flagged=False,
        ),
    ]
